...
public class HomeView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(container, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, 650, -1));

        container2.setBackground(new java.awt.Color(102, 204, 255));
        ...
        jPanel1.add(container2, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 91, -1, -1));

        jMenuBar1.setBackground(new java.awt.Color(102, 255, 0));

        jMenu1.setText("Cadastrar");

        bookRegister.setText("Cadastro de Livro");
        bookRegister.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bookRegisterActionPerformed(evt);
            }
        });
        jMenu1.add(bookRegister);
    ...
    private void bookRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookRegisterActionPerformed
        this.dispose();
